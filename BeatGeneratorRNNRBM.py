#Beat Generation with a Recurrent Neural Network of Restricted Boltzman Machines
...
n_visible      = 20000#2*note_range*num_timesteps #This is the size of the visible layer.
